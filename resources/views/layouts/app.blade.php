...
<body>
			...
			<div class="dropdown dropdown-end">
				...
				<div tabindex="0" class="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
					...
					<div class="card-actions">
                        <a class="btn btn-primary btn-block" href="{{ route('carrito') }}">Ver carrito</a>
					</div>
					</div>
				</div>
			</div>
	...
	<script>
		...
		// Cambiar el icono dependiendo el tema
		...
		// Al hacer click cambiar el icono
